...
?>
        ...
        <form action="{{url('')}}/themthietbi" method="post" style="width: 1220px; height: 780px; background-color: #f7f7f7; border: 1px solid #f7f7f7;">
        @csrf
                        ...
                        <div class="container">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input type="text" class="nhap_themthietbi" name="matb" placeholder="Nhập mã thiết bị" style="color: #848387;">
                                    @if($errors->has('matb')) 
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input type="text" class="nhap_themthietbi" name="tentb" placeholder="Nhập tên thiết bị" style="color: #848387;">
                                    @if($errors->has('tentb')) 
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input type="text" class="nhap_themthietbi" name="tendn" placeholder="Nhập tài khoản" style="color: #848387;">
                                    @if($errors->has('tendn')) 
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input type="text" class="nhap_themthietbi" name="diachiip" placeholder="Nhập địa chỉ IP" style="color: #848387;">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input type="password" class="nhap_themthietbi" name="matkhau" placeholder="Nhập mật khẩu" style="color: #848387;">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <input type="text" class="nhap_dv" name="dichvusd" placeholder="Nhập dịch vụ sử dụng" style="color: #848387;">
                            ...
                            <p style="margin-top: 140px; margin-left: 357px;">
                                ...
                                <script>
                                    alert('{{session('error')}}');
                                    window.location.href = "/Queuing_System/themthietbi";
                                </script>
                                @endif
                                @if(session('success'))
                                    <script>
