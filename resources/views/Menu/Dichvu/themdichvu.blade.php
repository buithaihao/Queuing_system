...
?>  
        ...
        <form action="{{url('')}}/themdichvu" method="post" style="width: 1220px; height: 760px; background-color: #f7f7f7; border: 1px solid #f7f7f7;">
        @csrf
            ...
            <div class="container mt-4" >
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        ...
                        <span style="font-size: 10px; position: absolute; top: 38px;"><i class="fa-solid fa-chevron-right"></i></span>
                        <span style="color: orangered; padding-left: 10px;">Thêm dịch vụ</span></p>
                    </div>
                </div>

                <div class="mt-2">
                    <h5 style="color: orangered; font-size: 28px;">Quản lý dịch vụ</h5>
                    <div class="khung_dichvu" style="height: 550px;">
                        <div class="container">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="col-lg-12">
                                        ...
                                        <input type="text" class="nhap_themthietbi" name="madv" placeholder="Nhập mã dịch vụ" style="color: #848387;">
                                            @if($errors->has('madv')) 
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <input type="text" class="nhap_themthietbi" name="tendv" placeholder="Nhập tên dịch vụ" style="color: #848387;">
                                            @if($errors->has('tendv')) 
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-lg-6" style="width: 190px;">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" id="check1" name="tangtudong" value="1">
                                        ...
                                        <div class="col-lg-6 mt-3" style="width: 190px;">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" id="check2" name="prefix" value="1">
                                        ...
                                        <div class="col-lg-6 mt-3" style="width: 190px;">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" id="check3" name="surfix" value="1">
                                        ...
                                        <div class="col-lg-6 mt-3" style="width: 190px;">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" id="check4" name="reset" value="1">
                            ...
                            <p style="margin-top: 90px; margin-left: 357px;">
                                <a href="{{url('/')}}/dichvu">
                                ...
                                @if(session('error'))
                                    <script>
                                        alert('{{session('error')}}');
                                        window.location.href = "/Queuing_System/themdichvu";
                                    </script>
                                @endif
                                @if(session('success'))
                                    <script>
