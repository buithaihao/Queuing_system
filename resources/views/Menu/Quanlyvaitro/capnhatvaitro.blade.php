...
?>
        ...
        <form action="{{ url('/capnhatvaitro/' . $role->roleid) }}" method="post" style="width: 1220px; height: 750px; background-color: #f7f7f7; border: 1px solid #f7f7f7;">
        @csrf
            <div class="container mt-4" >
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        ...
                        <span style="font-size: 10px; position: absolute; top: 38px;"><i class="fa-solid fa-chevron-right"></i></span>
                        <span style="color: orangered; padding-left: 10px;">Cập nhật vai trò</span></p>
                    </div>
                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="col-lg-12">
                                        ...
                                        <input type="text" class="nhap_themthietbi" name="tenvt" value="{{$role->rolename}}" placeholder="Nhập vai trò" style="color: #848387;" disabled>
                                            @if($errors->has('tenvt')) 
                                    ...
                                    <div class="col-lg-12">
                                        <!-- Input mô tả -->
                                        <p>Mô tả:
                                        <input type="text" class="nhap_themdichvu" name="mota" value="{{$role->describe}}" placeholder="Nhập mô tả" style="color: #848387;"></p>
                                    </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="col-lg-12">
                                        <!-- Phân quyền chức năng -->{{ $role->functionXA ? 'checked' : '' }}
                                        <p style="line-height: 0px; margin-top: 5px;">Phân quyền chức năng: <span class="text-danger">*</span> 
                                            <div class="list-role">
                                                ...
                                                <span class="form-check">
                                                    <input class="form-check-input" type="checkbox" id="ctthietbi" name="ctthietbi" value="Xem chi tiết thiết bị" style="margin-top: 7px;" {{ $role->Ctthietbi ? 'checked' : '' }}>
                                                    <label class="form-check-label" style="font-size: 18px; font-weight: 400;">Xem chi tiết thiết bị</label>
                                                </span>
                                                <span class="form-check">
                                                    <input class="form-check-input" type="checkbox" id="themthietbi" name="themthietbi" value="Thêm thiết bị" style="margin-top: 7px;" {{ $role->Tthietbi ? 'checked' : '' }}>
                                                    <label class="form-check-label" style="font-size: 18px; font-weight: 400;">Thêm thiết bị</label>
                                                </span>
                                                <span class="form-check">
                                                    <input class="form-check-input" type="checkbox" id="capnhatthietbi" name="capnhatthietbi" value="Cập nhật thiết bị" style="margin-top: 7px;" {{ $role->Cnthietbi ? 'checked' : '' }}>
                                                    <label class="form-check-label" style="font-size: 18px; font-weight: 400;">Cập nhật thiết bị</label>
                                                </span>
                                                <span class="form-check">
                                                    <input class="form-check-input" type="checkbox" id="ctdichvu" name="ctdichvu" value="Xem chi tiết dịch vụ" style="margin-top: 7px;" {{ $role->Ctdichvu ? 'checked' : '' }}>
                                                    <label class="form-check-label" style="font-size: 18px; font-weight: 400;">Xem chi tiết dịch vụ</label>
                                                </span>
                                                <span class="form-check">
                                                    <input class="form-check-input" type="checkbox" id="themdichvu" name="themdichvu" value="Thêm dịch vụ" style="margin-top: 7px;" {{ $role->Tdichvu ? 'checked' : '' }}>
                                                    <label class="form-check-label" style="font-size: 18px; font-weight: 400;">Thêm dịch vụ</label>
                                                </span>
                                                <span class="form-check">
                                                    <input class="form-check-input" type="checkbox" id="capnhatdichvu" name="capnhatdichvu" value="Cập nhật dịch vụ" style="margin-top: 7px;" {{ $role->Cndichvu ? 'checked' : '' }}>
                                                    <label class="form-check-label" style="font-size: 18px; font-weight: 400;">Cập nhật dịch vụ</label>
                                                </span>
                                                <span class="form-check">
                                                    <input class="form-check-input" type="checkbox" id="ctcapso" name="ctcapso" value="Xem chi tiết cấp số" style="margin-top: 7px;" {{ $role->Ctcapso ? 'checked' : '' }}>
                                                    <label class="form-check-label" style="font-size: 18px; font-weight: 400;">Xem chi tiết cấp số</label>
                                                </span>
                                                <span class="form-check">
                                                    <input class="form-check-input" type="checkbox" id="capso" name="capso" value="Cấp số" style="margin-top: 7px;" {{ $role->Capso ? 'checked' : '' }}>
                                                    <label class="form-check-label" style="font-size: 18px; font-weight: 400;">Cấp số</label>
                                                </span>
                                                <span class="form-check">
                                                    <input class="form-check-input" type="checkbox" id="themvaitro" name="themvaitro" value="Thêm vai trò" style="margin-top: 7px;" {{ $role->Tvaitro ? 'checked' : '' }}>
                                                    <label class="form-check-label" style="font-size: 18px; font-weight: 400;">Thêm vai trò</label>
                                                </span>
                                                <span class="form-check">
                                                    <input class="form-check-input" type="checkbox" id="capnhatvaitro" name="capnhatvaitro" value="Cập nhật vai trò" style="margin-top: 7px;" {{ $role->Cnvaitro ? 'checked' : '' }}>
                                                    <label class="form-check-label" style="font-size: 18px; font-weight: 400;">Cập nhật vai trò</label>
                                                </span>
                                                <span class="form-check">
                                                    <input class="form-check-input" type="checkbox" id="capnhattaikhoan" name="capnhattaikhoan" value="Cập nhật tài khoản" style="margin-top: 7px;" {{ $role->Cntaikhoan ? 'checked' : '' }}>
                                                    <label class="form-check-label" style="font-size: 18px; font-weight: 400;">Cập nhật tài khoản</label>
                                                </span>
                                                <span class="form-check">
                                                    <input class="form-check-input" type="checkbox" id="themtaikhoan" name="themtaikhoan" value="Thêm tài khoản" style="margin-top: 7px;" {{ $role->Ttaikhoan ? 'checked' : '' }}>
