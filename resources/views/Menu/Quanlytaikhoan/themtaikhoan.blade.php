...
?>
        ...
        <form action="{{url('')}}/themtaikhoan" method="post" style="width: 1220px; height: 800px; background-color: #f7f7f7; border: 1px solid #f7f7f7;">
        @csrf
                        ...
                        <div class="container">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input type="text" class="nhap_themthietbi" name="tennd" placeholder="Nhập họ tên" style="color: #848387;">
                                        @if($errors->has('tennd')) 
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input type="text" class="nhap_themthietbi" name="tendn" placeholder="Nhập tên đăng nhập" style="color: #848387;">
                                        @if($errors->has('tendn')) 
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input type="text" class="nhap_themthietbi" name="sdt" placeholder="Nhập số điện thoại" style="color: #848387;">
                                        @if($errors->has('sdt')) 
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input type="password" class="nhap_themthietbi" name="nlmatkhau" placeholder="Nhập lại mật khẩu" style="color: #848387;">
